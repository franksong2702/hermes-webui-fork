...
const LOCALES = {
  ...
  cmd_pet:'Wake or sleep desktop pet (Beta)',
  cmd_pet_wakeup_desc:'Pet, wake up (Beta)',
  cmd_pet_sleep_desc:'Pet, sleep (Beta)',
  cmd_pet_usage:'Usage: /pet wakeup or /pet sleep',
  cmd_pet_wakeup_done:'Desktop pet wakeup requested.',
  cmd_pet_sleep_done:'Desktop pet sleep requested.',
  cmd_pet_unavailable:'Desktop pet controls are not available on this page.',
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    desktop_pet_title: 'Desktop pet (Beta)',
    settings_desc_desktop_pet: 'Start the native desktop pet. If it is not installed yet, WebUI will guide you through setup first.',
    settings_open_desktop_pet: 'Start desktop pet',
    settings_desktop_pet_started: 'Desktop pet started.',
    settings_desktop_pet_already_running: 'Desktop pet is already running.',
    settings_desktop_pet_start_failed: 'Could not start desktop pet.',
    settings_desktop_pet_setup_title: 'Set up desktop pet',
    settings_desktop_pet_setup_prepare: 'Preparing desktop shell...',
    settings_desktop_pet_setup_load: 'Loading pet assets...',
    settings_desktop_pet_setup_ready: 'Ready. Starting the desktop pet now.',
    settings_desktop_pet_setup_starting: 'Starting desktop pet...',
    settings_desktop_pet_step_install: 'Install',
    settings_desktop_pet_step_load: 'Load',
    settings_desktop_pet_step_ready: 'Ready',
    settings_desktop_pet_launch_ready: 'Start desktop pet',
    desktop_pet_install_title: 'Starting desktop pet',
    desktop_pet_install_check_webui: 'Checking WebUI connection',
    desktop_pet_install_load_skins: 'Loading pet skins',
    desktop_pet_install_ready: 'Ready to use',
    ...
    desktop_pet_ready_for_review: 'Ready for review',
    desktop_pet_running: 'Running',
    desktop_pet_ready: 'Ready',
    desktop_pet_action_required: 'Action required',
    ...
    desktop_pet_more_sessions_below: (n) => `${n} more session${n === 1 ? '' : 's'} below`,
  ...
  cmd_pet:'Attiva o sospendi desktop pet (Beta)',
  cmd_pet_wakeup_desc:'Pet, wake up (Beta)',
  cmd_pet_sleep_desc:'Pet, sleep (Beta)',
  cmd_pet_usage:'Uso: /pet wakeup o /pet sleep',
  cmd_pet_wakeup_done:'Avvio del desktop pet richiesto.',
  cmd_pet_sleep_done:'Sospensione del desktop pet richiesta.',
  cmd_pet_unavailable:'I controlli del desktop pet non sono disponibili in questa pagina.',
  ...
  cmd_pet:'デスクトップペットを起こす/眠らせる（Beta）',
  cmd_pet_wakeup_desc:'Pet, wake up (Beta)',
  cmd_pet_sleep_desc:'Pet, sleep (Beta)',
  cmd_pet_usage:'使い方: /pet wakeup または /pet sleep',
  cmd_pet_wakeup_done:'デスクトップペットの起動を要求しました。',
  cmd_pet_sleep_done:'デスクトップペットの停止を要求しました。',
  cmd_pet_unavailable:'このページではデスクトップペット操作を利用できません。',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    desktop_pet_title: '桌面宠物（Beta）',
    settings_desc_desktop_pet: '启动原生桌面宠物。如果还没有安装，WebUI 会先引导你完成安装。',
    settings_open_desktop_pet: '启动桌面宠物',
    settings_desktop_pet_started: '桌面宠物已启动。',
    settings_desktop_pet_already_running: '桌面宠物已经在运行。',
    settings_desktop_pet_start_failed: '无法启动桌面宠物。',
    settings_desktop_pet_setup_title: '安装桌面宠物',
    settings_desktop_pet_setup_prepare: '正在准备桌面壳...',
    settings_desktop_pet_setup_load: '正在加载宠物资源...',
    settings_desktop_pet_setup_ready: '准备好了，正在启动桌面宠物。',
    settings_desktop_pet_setup_starting: '正在启动桌面宠物...',
    settings_desktop_pet_step_install: '安装',
    settings_desktop_pet_step_load: '加载',
    settings_desktop_pet_step_ready: '完成',
    settings_desktop_pet_launch_ready: '启动桌面宠物',
    desktop_pet_install_title: '正在启动桌面宠物',
    desktop_pet_install_check_webui: '正在检查 WebUI 连接',
    desktop_pet_install_load_skins: '正在加载宠物皮肤',
    desktop_pet_install_ready: '可以使用了',
    desktop_pet_ready_toast: '可以使用了。拖动宠物调整位置，右键切换皮肤，点击气泡打开会话。',
    desktop_pet_shell_label: '{0} 桌面宠物',
    desktop_pet_collapse_updates: '收起更新',
    desktop_pet_expand_updates: '展开更新',
    desktop_pet_thinking: '正在思考',
    desktop_pet_ready_for_review: '等待查看',
    desktop_pet_running: '运行中',
    desktop_pet_ready: '已完成',
    desktop_pet_action_required: '需要处理',
    desktop_pet_reply: '回复',
    desktop_pet_sending: '发送中...',
    desktop_pet_failed_to_send: '发送失败',
    desktop_pet_dismiss_update: '关闭这条更新',
    desktop_pet_latest: '最新',
    desktop_pet_more_sessions_below: (n) => `下方还有 ${n} 条`,
    desktop_pet_switch_skin: '切换皮肤',
    desktop_pet_restart: '重启宠物',
    desktop_pet_close: '关闭宠物',
  ...
  folder_add_as_space_title: '\u65b0\u589e\u70ba\u5de5\u4f5c\u5340\uff1f',
    ...
    desktop_pet_title: '桌面寵物（Beta）',
    settings_desc_desktop_pet: '啟動原生桌面寵物。如果還沒有安裝，WebUI 會先引導你完成安裝。',
    settings_open_desktop_pet: '啟動桌面寵物',
    settings_desktop_pet_started: '桌面寵物已啟動。',
    settings_desktop_pet_already_running: '桌面寵物已經在執行。',
    settings_desktop_pet_start_failed: '無法啟動桌面寵物。',
    settings_desktop_pet_setup_title: '安裝桌面寵物',
    settings_desktop_pet_setup_prepare: '正在準備桌面殼...',
    settings_desktop_pet_setup_load: '正在載入寵物資源...',
    settings_desktop_pet_setup_ready: '準備好了，正在啟動桌面寵物。',
    settings_desktop_pet_setup_starting: '正在啟動桌面寵物...',
    settings_desktop_pet_step_install: '安裝',
    settings_desktop_pet_step_load: '載入',
    settings_desktop_pet_step_ready: '完成',
    settings_desktop_pet_launch_ready: '啟動桌面寵物',
    desktop_pet_install_title: '正在啟動桌面寵物',
    desktop_pet_install_check_webui: '正在檢查 WebUI 連線',
    desktop_pet_install_load_skins: '正在載入寵物皮膚',
    desktop_pet_install_ready: '可以使用了',
    desktop_pet_ready_toast: '可以使用了。拖動寵物調整位置，右鍵切換皮膚，點擊氣泡開啟會話。',
    desktop_pet_shell_label: '{0} 桌面寵物',
    desktop_pet_collapse_updates: '收起更新',
    desktop_pet_expand_updates: '展開更新',
    desktop_pet_thinking: '正在思考',
    desktop_pet_ready_for_review: '等待查看',
    desktop_pet_running: '執行中',
    desktop_pet_ready: '已完成',
    desktop_pet_action_required: '需要處理',
    desktop_pet_reply: '回覆',
    desktop_pet_sending: '傳送中...',
    desktop_pet_failed_to_send: '傳送失敗',
    desktop_pet_dismiss_update: '關閉這則更新',
    desktop_pet_latest: '最新',
    desktop_pet_more_sessions_below: (n) => `下方還有 ${n} 則`,
    desktop_pet_switch_skin: '切換皮膚',
    desktop_pet_restart: '重啟寵物',
    desktop_pet_close: '關閉寵物',
    ...
    cmd_undo: '\u79fb\u9664\u6700\u5f8c\u4e00\u8f2a\u5c0d\u8a71',
    cmd_voice: '\u5207\u63db\u9ea5\u514b\u98a8\u8f38\u5165',
    cmd_pet: '唤醒或休眠桌宠（Beta）',
    cmd_pet_wakeup_desc: 'Pet, wake up (Beta)',
    cmd_pet_sleep_desc: 'Pet, sleep (Beta)',
    cmd_pet_usage: '用法：/pet wakeup 或 /pet sleep',
    cmd_pet_wakeup_done: '已请求唤醒桌宠。',
    cmd_pet_sleep_done: '已请求休眠桌宠。',
    cmd_pet_unavailable: '当前页面不可用桌宠控制。',
  ...
  pt: {
    ...
    cmd_pet: 'Acordar ou dormir o pet de desktop (Beta)',
    cmd_pet_wakeup_desc: 'Pet, wake up (Beta)',
    cmd_pet_sleep_desc: 'Pet, sleep (Beta)',
    cmd_pet_usage: 'Uso: /pet wakeup ou /pet sleep',
    cmd_pet_wakeup_done: 'Solicitado acordar o pet de desktop.',
    cmd_pet_sleep_done: 'Solicitado dormir o pet de desktop.',
    cmd_pet_unavailable: 'Controles do pet de desktop indisponíveis nesta página.',
  ...
  ko: {
    ...
    cmd_status: '세션 정보 표시',
    cmd_voice: '마이크 입력 전환',
    cmd_pet: '데스크톱 펫 깨우기/재우기 (Beta)',
    cmd_pet_wakeup_desc: 'Pet, wake up (Beta)',
    cmd_pet_sleep_desc: 'Pet, sleep (Beta)',
    cmd_pet_usage: '사용법: /pet wakeup 또는 /pet sleep',
    cmd_pet_wakeup_done: '데스크톱 펫 깨우기를 요청했습니다.',
    cmd_pet_sleep_done: '데스크톱 펫 재우기를 요청했습니다.',
    cmd_pet_unavailable: '이 페이지에서는 데스크톱 펫 제어를 사용할 수 없습니다.',
